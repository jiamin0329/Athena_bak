...
namespace ATHENA
{
    ...
    AthenaMPI::AthenaMPI(const Comm& comm):
            d_comm(comm),
            d_rank(-1),
            d_size(-1)
    {
    ...
    AthenaMPI::AthenaMPI(const AthenaMPI& other):
            d_comm(other.d_comm),
            d_rank(other.d_rank),
            d_size(other.d_size)
    {
    ...
    void AthenaMPI::SetCommunicator(const Comm& comm)
    {
        d_comm = comm;
        d_rank = 0;
        d_size = 1;
    ...
    void AthenaMPI::DupCommunicator(const AthenaMPI& r)
    {
#ifdef ATHENA_HAVE_MPI
    ...
    void AthenaMPI::FreeCommunicator()
    {
#ifdef ATHENA_HAVE_MPI
        if (d_comm != MPI_COMM_NULL)
        {
    ...
    int AthenaMPI::CompareCommunicator(const AthenaMPI& r) const
    {
#ifdef ATHENA_HAVE_MPI
        int compare_result;
    ...
    int AthenaMPI::Comm_rank(Comm comm, int* rank)
    {
    ...
    int AthenaMPI::Comm_size(Comm comm, int* size)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(comm);
#endif
    ...
    int AthenaMPI::Comm_compare(Comm comm1, Comm comm2, int* result)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(comm1);
        NULL_USE(comm2);
    ...
    int AthenaMPI::Comm_free(Comm* comm)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(comm);
#endif
    ...
    int AthenaMPI::Finalized(int* flag)
    {
        int rval = MPI_SUCCESS;
#ifdef ATHENA_HAVE_MPI
    ...
    int AthenaMPI::Get_count(Status* status, Datatype datatype, int* count)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(status);
        NULL_USE(datatype);
    ...
    int AthenaMPI::Request_free(Request* request)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(request);
#endif
    ...
    int AthenaMPI::Test(Request* request, int* flag, Status* status)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(request);
        NULL_USE(flag);
    ...
    int AthenaMPI::Test_cancelled(Status* status, int* flag)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(status);
        NULL_USE(flag);
    ...
    int AthenaMPI::Wait(Request* request, Status* status)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(request);
        NULL_USE(status);
    ...
    int AthenaMPI::Waitall(int count, Request* reqs, Status* stats)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(count);
        NULL_USE(reqs);
    ...
    int AthenaMPI::Waitany(int count, Request* array_of_requests, int* index, Status* status)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(count);
    ...
    int AthenaMPI::Waitsome(int incount, Request* array_of_requests, int* outcount, int* array_of_indices, Status* array_of_statuses)
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(incount);
        NULL_USE(array_of_requests);
    ...
    int AthenaMPI::Allgather(void* sendbuf, int sendcount, Datatype sendtype, void* recvbuf, int recvcount, Datatype recvtype) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(sendbuf);
        NULL_USE(sendcount);
    ...
    int AthenaMPI::Allgatherv(void* sendbuf, int sendcounts, Datatype sendtype,
    ...
    int AthenaMPI::Allreduce(void* sendbuf, void* recvbuf, int count, Datatype datatype, Op op) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(sendbuf);
        NULL_USE(recvbuf);
    ...
    int AthenaMPI::Attr_get(int keyval, void* attribute_val, int* flag) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(keyval);
    ...
    int AthenaMPI::Bcast(void* buffer, int count, Datatype datatype, int root) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(buffer);
        NULL_USE(count);
    ...
    int AthenaMPI::Comm_dup(Comm* newcomm) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(newcomm);
#endif
    ...
    int AthenaMPI::Comm_rank(int* rank) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(rank);
#endif
    ...
    int AthenaMPI::Comm_size(int* size) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(size);
#endif
    ...
    int AthenaMPI::Gather(void* sendbuf, int sendcount, Datatype sendtype,
    ...
    int AthenaMPI::Gatherv(void* sendbuf, int sendcount, Datatype sendtype,
    ...
    int AthenaMPI::Iprobe(int source, int tag, int* flag, Status* status) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(source);
        NULL_USE(tag);
    ...
    int AthenaMPI::Isend(void* buf, int count, Datatype datatype,
    ...
    int AthenaMPI::Irecv(void* buf, int count, Datatype datatype,
    ...
    int AthenaMPI::Probe(int source, int tag, Status* status) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(source);
        NULL_USE(tag);
    ...
    int AthenaMPI::Recv(void* buf, int count, Datatype datatype, int source, int tag, Status* status) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(buf);
        NULL_USE(count);
    ...
    int AthenaMPI::Reduce(void* sendbuf, void* recvbuf, int count, Datatype datatype, Op op, int root) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(sendbuf);
        NULL_USE(recvbuf);
    ...
    int AthenaMPI::Send(void* buf, int count, Datatype datatype, int dest, int tag) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(buf);
        NULL_USE(count);
    ...
    int AthenaMPI::Sendrecv(void* sendbuf, int sendcount, Datatype sendtype, int dest, int sendtag,
    ...
    int AthenaMPI::Scan(void* sendbuf, void* recvbuf, int count, Datatype datatype, Op op) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(sendbuf);
        NULL_USE(recvbuf);
     ...
     */
    int AthenaMPI::AllReduce(int* x, int count, Op op, int* ranks_of_extrema) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(x);
        NULL_USE(count);
    ...
    int AthenaMPI::AllReduce(double* x, int count, Op op, int* ranks_of_extrema) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(x);
        NULL_USE(count);
    ...
    int AthenaMPI::AllReduce( float* x, int count, Op op, int* ranks_of_extrema) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(x);
        NULL_USE(count);
    ...
    int AthenaMPI::ParallelPrefixSum(int* x, int count, int tag) const
    {
#ifndef ATHENA_HAVE_MPI
        NULL_USE(x);
        NULL_USE(count);
    ...
    bool AthenaMPI::HasReceivableMessage(Status* status, int source, int tag) const
    {
        int flag = false;
        if (d_mpiIsInitialized)
        {
    ...
    void AthenaMPI::Init(int* argc, char** argv[])
    {
#ifdef ATHENA_HAVE_MPI
        MPI_Init(argc, argv);
    ...
    void AthenaMPI::Init(Comm comm)
    {
        if (comm == MPI_COMM_NULL)
        {
            std::cerr << "AthenaMPI::Init: invalid initializing Communicator."
                      << std::endl;
        }
#ifdef ATHENA_HAVE_MPI
        d_mpiIsInitialized = true;
    ...
    void AthenaMPI::InitMPIDisabled()
    {
